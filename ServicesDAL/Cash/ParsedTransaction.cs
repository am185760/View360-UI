...
namespace ServicesDAL
{
    ...
    public class ParsedTransaction
    {
        ...
        public ParsedTransaction(long atm_id, decimal amount, DateTime trxn_datetime, int cash_remaining1, int cash_remaining2, int cash_remaining3, int cash_remaining4, int cash_remaining5, int cash_remaining6, int cash_remaining7, int cash_dispensed1, int cash_dispensed2, int cash_dispensed3, int cash_dispensed4, int cash_dispensed5, int cash_dispensed6, int cash_dispensed7, int cash_purged1, int cash_purged2, int cash_purged3, int cash_purged4, int cash_purged5, int cash_purged6, int cash_purged7, long parsed_transaction_id, long task_id)
        {
            this.atm_id = atm_id;
        ...
        public ParsedTransaction(long atm_id, decimal amount, DateTime trxn_datetime, int cash_remaining1, int cash_remaining2, int cash_remaining3, int cash_remaining4, int cash_remaining5, int cash_remaining6, int cash_remaining7, int cash_dispensed1, int cash_dispensed2, int cash_dispensed3, int cash_dispensed4, int cash_dispensed5, int cash_dispensed6, int cash_dispensed7, int cash_purged1, int cash_purged2, int cash_purged3, int cash_purged4, int cash_purged5, int cash_purged6, int cash_purged7, long task_id, string pan, string tsn, bool? is_auto_generated, DateTime? processing_datetime, bool? is_eligible, bool? isBillDispenser)
        {
            this.atm_id = atm_id;
            this.atm_idChanged = true;
            this.amount = amount;
            ...
            this.isBillDispenser = isBillDispenser;
            this.isBillDispenserChanged = true;
        }
        private ParsedTransaction(long atm_id, decimal amount, DateTime trxn_datetime, int cash_remaining1, int cash_remaining2, int cash_remaining3, int cash_remaining4, int cash_remaining5, int cash_remaining6, int cash_remaining7, int cash_dispensed1, int cash_dispensed2, int cash_dispensed3, int cash_dispensed4, int cash_dispensed5, int cash_dispensed6, int cash_dispensed7, int cash_purged1, int cash_purged2, int cash_purged3, int cash_purged4, int cash_purged5, int cash_purged6, int cash_purged7, long parsed_transaction_id, long task_id, string pan, string tsn, bool? is_auto_generated, DateTime? processing_datetime, bool? is_eligible, bool? isBillDispenser)
        {
            this.atm_id = atm_id;
            this.atm_idChanged = true;
            this.amount = amount;
        ...
        private long parsed_transaction_id;
        public long ParsedTransactionId
        {
        ...
        private bool isBillDispenserChanged = false;
        private bool? isBillDispenser;
        public bool? IsBillDispenser
        {
            get { return isBillDispenser; }
            set
            {
                isBillDispenser = value;
                isBillDispenserChanged = true;
            }
        }
        private string isBillDispenserDbString
        {
            get
            {
                if (this.isBillDispenser.HasValue)
                    return isBillDispenser.Value ? "1" : "0";
                else
                    return "null";
            }
        }
                ...
                if (reader.Read())
                {
                    ...
                    if (partialRead)
                    {
                        if ((columns & Columns.atm_id) == Columns.atm_id && reader["atm_id"] != DBNull.Value)
                            currentParsedTransaction.atm_id = (long)reader["atm_id"];
                        ...
                        if ((columns & Columns.parsed_transaction_id) == Columns.parsed_transaction_id && reader["parsed_transaction_id"] != DBNull.Value)
                            currentParsedTransaction.parsed_transaction_id = (long)reader["parsed_transaction_id"];
                        if ((columns & Columns.task_id) == Columns.task_id && reader["task_id"] != DBNull.Value)
                            currentParsedTransaction.task_id = (long)reader["task_id"];
                        ...
                        if ((columns & Columns.IsBillDispenser) == Columns.IsBillDispenser && reader["IsBillDispenser"] != DBNull.Value)
                            currentParsedTransaction.isBillDispenser = (bool?)reader["IsBillDispenser"];
                    ...
                    else
                    {
                        ...
                        if (reader["is_eligible"] != DBNull.Value)
                            currentParsedTransaction.is_eligible = (bool?)reader["is_eligible"];
                        if (reader["IsBillDispenser"] != DBNull.Value)
                            currentParsedTransaction.isBillDispenser = (bool?)reader["IsBillDispenser"];
                    }
        ...
        public static ParsedTransactionReader ExecuteReader(string where, IDbConnection conn, Columns columns)
        {
            ...
            if (Columns.IsBillDispenser == (Columns.IsBillDispenser & columns))
                qry.Append("IsBillDispenser,");
        ...
        public static ParsedTransactionReader ExecuteReader(string where, IDbConnection conn)
        {
            ...
            cmd.CommandText = "SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED";
            cmd.ExecuteNonQuery();
            cmd.CommandText = "Select atm_id,amount,trxn_datetime,cash_remaining1,cash_remaining2,cash_remaining3,cash_remaining4,cash_remaining5,cash_remaining6,cash_remaining7,cash_dispensed1,cash_dispensed2,cash_dispensed3,cash_dispensed4,cash_dispensed5,cash_dispensed6,cash_dispensed7,cash_purged1,cash_purged2,cash_purged3,cash_purged4,cash_purged5,cash_purged6,cash_purged7,parsed_transaction_id,task_id,pan,tsn,is_auto_generated,processing_datetime,is_eligible,IsBillDispenser from Parsed_transaction ";
            if (where != null && where.Trim().Length > 0)
        ...
        public static ParsedTransaction LoadParsedTransactionByPk(DateTime trxn_datetime, long parsed_transaction_id)
        {
            return LoadParsedTransaction("trxn_datetime=Convert(datetime,'" + trxn_datetime.ToString("yyyy-MM-dd HH:mm:ss.fff") + "',121)" + " and parsed_transaction_id=" + parsed_transaction_id);
        }

        public static ParsedTransaction LoadParsedTransactionByPk(DateTime trxn_datetime, long parsed_transaction_id, IDbConnection conn)
        {
            return LoadParsedTransaction(" trxn_datetime=Convert(datetime,'" + trxn_datetime.ToString("yyyy-MM-dd HH:mm:ss.fff") + "',121)" + " and parsed_transaction_id=" + parsed_transaction_id, conn);
        }

        public void Save()
        {
            if (atm_idChanged || amountChanged || trxn_datetimeChanged || cash_remaining1Changed || cash_remaining2Changed || cash_remaining3Changed || cash_remaining4Changed || cash_remaining5Changed || cash_remaining6Changed || cash_remaining7Changed || cash_dispensed1Changed || cash_dispensed2Changed || cash_dispensed3Changed || cash_dispensed4Changed || cash_dispensed5Changed || cash_dispensed6Changed || cash_dispensed7Changed || cash_purged1Changed || cash_purged2Changed || cash_purged3Changed || cash_purged4Changed || cash_purged5Changed || cash_purged6Changed || cash_purged7Changed || parsed_transaction_idChanged || task_idChanged || panChanged || tsnChanged || is_auto_generatedChanged || processing_datetimeChanged || is_eligibleChanged || isBillDispenserChanged)
        ...
        private void ExcuteSave(IDbCommand cmd)
        {
            if (atm_idChanged || amountChanged || trxn_datetimeChanged || cash_remaining1Changed || cash_remaining2Changed || cash_remaining3Changed || cash_remaining4Changed || cash_remaining5Changed || cash_remaining6Changed || cash_remaining7Changed || cash_dispensed1Changed || cash_dispensed2Changed || cash_dispensed3Changed || cash_dispensed4Changed || cash_dispensed5Changed || cash_dispensed6Changed || cash_dispensed7Changed || cash_purged1Changed || cash_purged2Changed || cash_purged3Changed || cash_purged4Changed || cash_purged5Changed || cash_purged6Changed || cash_purged7Changed || parsed_transaction_idChanged || task_idChanged || panChanged || tsnChanged || is_auto_generatedChanged || processing_datetimeChanged || is_eligibleChanged || isBillDispenserChanged)
            {
                ...
                if (this.isNewEntity)
                {
                    qry.Append(@"insert into Parsed_transaction(atm_id,amount,trxn_datetime,cash_remaining1,cash_remaining2,cash_remaining3,cash_remaining4,cash_remaining5,cash_remaining6,cash_remaining7,cash_dispensed1,cash_dispensed2,cash_dispensed3,cash_dispensed4,cash_dispensed5,cash_dispensed6,cash_dispensed7,cash_purged1,cash_purged2,cash_purged3,cash_purged4,cash_purged5,cash_purged6,cash_purged7,parsed_transaction_id,task_id,pan,tsn,is_auto_generated,processing_datetime,is_eligible,IsBillDispenser) values(");
                    ...
                    {
                        this.parsed_transaction_id = ConnectionFactory.GetNextId(DatabaseName.Cash);
                    ...
                    qry.Append(isBillDispenserDbString);
                    qry.Append(");");
                ...
                else
                {
                    ...
                    if (isBillDispenserChanged)
                    {
                        qry.Append("IsBillDispenser =" + isBillDispenserDbString);
                        qry.Append(",");
                    }
                    ...
                    qry.Append(" and parsed_transaction_id = " + parsed_transaction_idDbString);
                }
        ...
        {
            IDbCommand cmd = conn.CreateCommand();
            cmd.CommandText = "DELETE Parsed_transaction wheretrxn_datetime= " + trxn_datetime + " and parsed_transaction_id= " + parsed_transaction_id;
        ...
        {
            ConnectionFactory.ExecuteQuery("delete Parsed_transaction where " + where, DatabaseName.Cash);
        }
        ...
        public enum Columns : uint
        {
            ...
            cash_purged6 = 22,
            cash_purged7 = 23,
            parsed_transaction_id = 24,
            task_id = 25,
            pan = 26,
            tsn = 27,
            is_auto_generated = 28,
            processing_datetime = 29,
            is_eligible = 30,
            IsBillDispenser = 31
        }
        #endregion
        public DataTable BulkSave(List<ParsedTransaction> dataArray)
        {
            DataTable dt = new DataTable();
            CreateDataTable(dt);
            AddToDataTable(dataArray, ref dt);
            SqlBulkCopy bulk = new SqlBulkCopy(ConnectionFactory.connectionStringCash, SqlBulkCopyOptions.FireTriggers);
        ...
        public void AddToDataTable(List<ParsedTransaction> transList, ref DataTable dt)
        {
            foreach (ParsedTransaction tran in transList)
            {
                ...
                Row["parsed_transaction_id"] = ConnectionFactory.GetNextId(DatabaseName.Cash);
                ...
                Row["isBillDispenser"] = tran.IsBillDispenser;
                dt.Rows.Add(Row);
            }
        }
    }
