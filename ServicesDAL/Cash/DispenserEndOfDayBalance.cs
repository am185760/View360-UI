...
namespace ServicesDAL
{
    ...
    public class DispenserEndOfDayBalance
    {
        ...
        public DispenserEndOfDayBalance(long atm_id, DateTime counter_file_datetime, int cassette1_remaining_notes, int cassette2_remaining_notes, int cassette3_remaining_notes, int cassette4_remaining_notes, int cassette5_remaining_notes, int cassette6_remaining_notes, int cassette7_remaining_notes, int cassette1_dispensed_notes, int cassette2_dispensed_notes, int cassette3_dispensed_notes, int cassette4_dispensed_notes, int cassette5_dispensed_notes, int cassette6_dispensed_notes, int cassette7_dispensed_notes, int cassette1_purged_notes, int cassette2_purged_notes, int cassette3_purged_notes, int cassette4_purged_notes, int cassette5_purged_notes, int cassette6_purged_notes, int cassette7_purged_notes, DateTime processed_at_datetime)
        {
            this.atm_id = atm_id;
        ...
        private DispenserEndOfDayBalance(long dispenser_end_of_day_balance_id, long atm_id, DateTime counter_file_datetime, int cassette1_remaining_notes, int cassette2_remaining_notes, int cassette3_remaining_notes, int cassette4_remaining_notes, int cassette5_remaining_notes, int cassette6_remaining_notes, int cassette7_remaining_notes, int cassette1_dispensed_notes, int cassette2_dispensed_notes, int cassette3_dispensed_notes, int cassette4_dispensed_notes, int cassette5_dispensed_notes, int cassette6_dispensed_notes, int cassette7_dispensed_notes, int cassette1_purged_notes, int cassette2_purged_notes, int cassette3_purged_notes, int cassette4_purged_notes, int cassette5_purged_notes, int cassette6_purged_notes, int cassette7_purged_notes, DateTime processed_at_datetime)
        {
        ...
        private long dispenser_end_of_day_balance_id;
        public long DispenserEndOfDayBalanceId
        {
                ...
                if (reader.Read())
                {
                    ...
                    if (partialRead)
                    {
                        if ((columns & Columns.dispenser_end_of_day_balance_id) == Columns.dispenser_end_of_day_balance_id && reader["dispenser_end_of_day_balance_id"] != DBNull.Value)
                            currentDispenserEndOfDayBalance.dispenser_end_of_day_balance_id = (long)reader["dispenser_end_of_day_balance_id"];
                        if ((columns & Columns.atm_id) == Columns.atm_id && reader["atm_id"] != DBNull.Value)
                            currentDispenserEndOfDayBalance.atm_id = (long)reader["atm_id"];
        ...
        public static DispenserEndOfDayBalance LoadDispenserEndOfDayBalanceByPk(long dispenser_end_of_day_balance_id)
        {
            return LoadDispenserEndOfDayBalance("dispenser_end_of_day_balance_id=" + dispenser_end_of_day_balance_id);
        }

        public static DispenserEndOfDayBalance LoadDispenserEndOfDayBalanceByPk(long dispenser_end_of_day_balance_id, IDbConnection conn)
        {
        ...
        private void ExcuteSave(IDbCommand cmd)
        {
            if (dispenser_end_of_day_balance_idChanged || atm_idChanged || counter_file_datetimeChanged || cassette1_remaining_notesChanged || cassette2_remaining_notesChanged || cassette3_remaining_notesChanged || cassette4_remaining_notesChanged || cassette5_remaining_notesChanged || cassette6_remaining_notesChanged || cassette7_remaining_notesChanged || cassette1_dispensed_notesChanged || cassette2_dispensed_notesChanged || cassette3_dispensed_notesChanged || cassette4_dispensed_notesChanged || cassette5_dispensed_notesChanged || cassette6_dispensed_notesChanged || cassette7_dispensed_notesChanged || cassette1_purged_notesChanged || cassette2_purged_notesChanged || cassette3_purged_notesChanged || cassette4_purged_notesChanged || cassette5_purged_notesChanged || cassette6_purged_notesChanged || cassette7_purged_notesChanged || processed_at_datetimeChanged)
            {
                ...
                if (this.isNewEntity)
                {
                    ...
                    {
                        this.dispenser_end_of_day_balance_id = ConnectionFactory.GetNextId(DatabaseName.Cash);
        ...
        {
            IDbCommand cmd = conn.CreateCommand();
            cmd.CommandText = "DELETE Dispenser_end_of_day_balance wheredispenser_end_of_day_balance_id= " + dispenser_end_of_day_balance_id;
        ...
        {
            ConnectionFactory.ExecuteQuery("delete Dispenser_end_of_day_balance where " + where, DatabaseName.Cash);
        }
        ...
        {
            dispenser_end_of_day_balance_id = 0,
            atm_id = 1,
            counter_file_datetime = 2,
            cassette1_remaining_notes = 3,
            cassette2_remaining_notes = 4,
            cassette3_remaining_notes = 5,
            cassette4_remaining_notes = 6,
            cassette5_remaining_notes = 7,
            cassette6_remaining_notes = 8,
            cassette7_remaining_notes = 9,
            cassette1_dispensed_notes = 10,
            cassette2_dispensed_notes = 11,
            cassette3_dispensed_notes = 12,
            cassette4_dispensed_notes = 13,
            cassette5_dispensed_notes = 14,
            cassette6_dispensed_notes = 15,
            cassette7_dispensed_notes = 16,
            cassette1_purged_notes = 17,
            cassette2_purged_notes = 18,
            cassette3_purged_notes = 19,
            cassette4_purged_notes = 20,
            cassette5_purged_notes = 21,
            cassette6_purged_notes = 22,
            cassette7_purged_notes = 23,
            processed_at_datetime = 24
        }
        #endregion
        public DataTable BulkSave(List<DispenserEndOfDayBalance> dataArray, SqlTransaction dbTrx)
        {
        ...
        public void AddToDataTable(List<DispenserEndOfDayBalance> transList, ref DataTable dt)
        {
            foreach (DispenserEndOfDayBalance tran in transList)
            {
                DataRow Row;
                Row = dt.NewRow();
                Row["dispenser_end_of_day_balance_id"] = ConnectionFactory.GetNextId(DatabaseName.Cash);
