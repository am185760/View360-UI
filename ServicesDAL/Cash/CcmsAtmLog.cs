...
namespace servicesDAL
{
    ...
    public class CcmsAtmLog
    {
        ...
        public CcmsAtmLog() { }
        public CcmsAtmLog(long id, int task_id, DateTime processing_datetime)
        {
        ...
        public CcmsAtmLog(string event_name, DateTime? event_occured_at, string event_mode, string event_info, long? atm_id, string order_number, int task_id, DateTime processing_datetime)
        {
        ...
        private CcmsAtmLog(long id, string event_name, DateTime? event_occured_at, string event_mode, string event_info, long? atm_id, string order_number, int task_id, DateTime processing_datetime)
        {
            this.id = id;
            this.idChanged = true;
            this.event_name = event_name;
        ...
        public static CcmsAtmLog LoadCcmsAtmLogByPk(long id)
        {
            return LoadCcmsAtmLog("id=" + id);
        }

        public static CcmsAtmLog LoadCcmsAtmLogByPk(long id, IDbConnection conn)
        {
        ...
        {
            IDbCommand cmd = conn.CreateCommand();
            cmd.CommandText = "DELETE Ccms_atm_log whereid= " + id;
        ...
        #endregion
        public DataTable BulkSave(List<CcmsAtmLog> dataArray)
        {
