...
namespace ServicesDAL
{
    ...
    public class Replenishment
    {
        ...
        public Replenishment(long atm_id, int cash_added1, int cash_added2, int cash_added3, int cash_added4, int cash_added5, int cash_added6, int cash_added7, DateTime rep_datetime, string rep_status, long replenishment_id, long task_id, bool is_swap)
        {
            this.atm_id = atm_id;
        ...
        public Replenishment(long atm_id, int cash_added1, int cash_added2, int cash_added3, int cash_added4, int cash_added5, int cash_added6, int cash_added7, DateTime rep_datetime, string rep_status, long task_id, long? cash_order_id, bool is_swap, DateTime? generated_at, bool? is_updated, long? modified_by, DateTime? modified_datetime, long? generated_by, string reason, decimal? rep_amount, int? last_tsn, bool? isBillDispenser)
        {
            this.atm_id = atm_id;
            this.atm_idChanged = true;
            this.cash_added1 = cash_added1;
        ...
        private Replenishment(long atm_id, int cash_added1, int cash_added2, int cash_added3, int cash_added4, int cash_added5, int cash_added6, int cash_added7, DateTime rep_datetime, string rep_status, long replenishment_id, long task_id, long? cash_order_id, bool is_swap, DateTime? generated_at, bool? is_updated, long? modified_by, DateTime? modified_datetime, long? generated_by, string reason, decimal? rep_amount, int? last_tsn, bool? isBillDispenser)
        {
            this.atm_id = atm_id;
            this.atm_idChanged = true;
            this.cash_added1 = cash_added1;
                ...
                if (reader.Read())
                {
                    ...
                    if (partialRead)
                    {
                        if ((columns & Columns.atm_id) == Columns.atm_id && reader["atm_id"] != DBNull.Value)
                            currentReplenishment.atm_id = (long)reader["atm_id"];
                        ...
                        if ((columns & Columns.replenishment_id) == Columns.replenishment_id && reader["replenishment_id"] != DBNull.Value)
                            currentReplenishment.replenishment_id = (long)reader["replenishment_id"];
                        if ((columns & Columns.task_id) == Columns.task_id && reader["task_id"] != DBNull.Value)
                            currentReplenishment.task_id = (long)reader["task_id"];
                        if ((columns & Columns.cash_order_id) == Columns.cash_order_id && reader["cash_order_id"] != DBNull.Value)
                            currentReplenishment.cash_order_id = (long?)reader["cash_order_id"];
                        ...
                        if ((columns & Columns.modified_by) == Columns.modified_by && reader["modified_by"] != DBNull.Value)
                            currentReplenishment.modified_by = (long?)reader["modified_by"];
                        ...
                        if ((columns & Columns.generated_by) == Columns.generated_by && reader["generated_by"] != DBNull.Value)
                            currentReplenishment.generated_by = (long?)reader["generated_by"];
                        ...
                        if ((columns & Columns.IsBillDispenser) == Columns.IsBillDispenser && reader["IsBillDispenser"] != DBNull.Value)
                            currentReplenishment.isBillDispenser = (bool?)reader["IsBillDispenser"];
        ...
        public static ReplenishmentReader ExecuteReader(string where, IDbConnection conn)
        {
            ...
            cmd.CommandText = "SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED";
            cmd.ExecuteNonQuery();
            cmd.CommandText = "Select atm_id,cash_added1,cash_added2,cash_added3,cash_added4,cash_added5,cash_added6,cash_added7,rep_datetime,rep_status,replenishment_id,task_id,cash_order_id,is_swap,generated_at,is_updated,modified_by,modified_datetime,generated_by,reason,rep_amount,last_tsn,IsBillDispenser from Replenishment ";
            if (where != null && where.Trim().Length > 0)
        ...
        public static Replenishment LoadReplenishmentByPk(DateTime rep_datetime, long replenishment_id)
        {
            return LoadReplenishment("rep_datetime=Convert(datetime,'" + rep_datetime.ToString("yyyy-MM-dd HH:mm:ss.fff") + "',121)" + " and replenishment_id=" + replenishment_id);
        }

        public static Replenishment LoadReplenishmentByPk(DateTime rep_datetime, long replenishment_id, IDbConnection conn)
        {
            return LoadReplenishment(" rep_datetime=Convert(datetime,'" + rep_datetime.ToString("yyyy-MM-dd HH:mm:ss.fff") + "',121)" + " and replenishment_id=" + replenishment_id, conn);
        }

        public void Save()
        {
            if (atm_idChanged || cash_added1Changed || cash_added2Changed || cash_added3Changed || cash_added4Changed || cash_added5Changed || cash_added6Changed || cash_added7Changed || rep_datetimeChanged || rep_statusChanged || replenishment_idChanged || task_idChanged || cash_order_idChanged || is_swapChanged || generated_atChanged || is_updatedChanged || modified_byChanged || modified_datetimeChanged || generated_byChanged || reasonChanged || rep_amountChanged || last_tsnChanged || isBillDispenserChanged)
        ...
        private void ExcuteSave(IDbCommand cmd)
        {
            if (atm_idChanged || cash_added1Changed || cash_added2Changed || cash_added3Changed || cash_added4Changed || cash_added5Changed || cash_added6Changed || cash_added7Changed || rep_datetimeChanged || rep_statusChanged || replenishment_idChanged || task_idChanged || cash_order_idChanged || is_swapChanged || generated_atChanged || is_updatedChanged || modified_byChanged || modified_datetimeChanged || generated_byChanged || reasonChanged || rep_amountChanged || last_tsnChanged || isBillDispenserChanged)
            {
                ...
                if (this.isNewEntity)
                {
                    qry.Append(@"insert into Replenishment(atm_id,cash_added1,cash_added2,cash_added3,cash_added4,cash_added5,cash_added6,cash_added7,rep_datetime,rep_status,replenishment_id,task_id,cash_order_id,is_swap,generated_at,is_updated,modified_by,modified_datetime,generated_by,reason,rep_amount,last_tsn,IsBillDispenser) values(");
                    ...
                    {
                        this.replenishment_id = ConnectionFactory.GetNextId(DatabaseName.Cash);
                ...
                else
                {
                    ...
                    qry.Append(" and replenishment_id = " + replenishment_idDbString);
                }
        ...
        {
            IDbCommand cmd = conn.CreateCommand();
            cmd.CommandText = "DELETE Replenishment whererep_datetime= " + rep_datetime + " and replenishment_id= " + replenishment_id;
        ...
        {
            ConnectionFactory.ExecuteQuery("delete Replenishment where " + where, DatabaseName.Cash);
        }
        ...
        #endregion
        public DataTable BulkSave(List<Replenishment> dataArray)
        {
        ...
        public void AddToDataTable(List<Replenishment> transList, ref DataTable dt)
        {
            foreach (Replenishment tran in transList)
            {
                ...
                Row["replenishment_id"] = ConnectionFactory.GetNextId(DatabaseName.Cash);
