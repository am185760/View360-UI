...
public Dispensed() { }
public Dispensed( int atm_id,int cash_remaining1,int cash_remaining2,int cash_remaining3,int cash_remaining4,int cash_remaining5,int cash_remaining6,int cash_remaining7,int cash_dispensed1,int cash_dispensed2,int cash_dispensed3,int cash_dispensed4,int cash_dispensed5,int cash_dispensed6,int cash_dispensed7,int cash_purged1,int cash_purged2,int cash_purged3,int cash_purged4,int cash_purged5,int cash_purged6,int cash_purged7,DateTime clearing_datetime,int task_id )
{
this.atm_id = atm_id;
...
private Dispensed( int atm_id,int cash_remaining1,int cash_remaining2,int cash_remaining3,int cash_remaining4,int cash_remaining5,int cash_remaining6,int cash_remaining7,int cash_dispensed1,int cash_dispensed2,int cash_dispensed3,int cash_dispensed4,int cash_dispensed5,int cash_dispensed6,int cash_dispensed7,int cash_purged1,int cash_purged2,int cash_purged3,int cash_purged4,int cash_purged5,int cash_purged6,int cash_purged7,DateTime clearing_datetime,int dispensed_id,int task_id )
{
this.atm_id = atm_id;
this.atm_idChanged = true;
this.cash_remaining1 = cash_remaining1;
...
private int dispensed_id;
public int DispensedId
{
...
currentDispensed.atm_id =(int) reader["atm_id"]; 
...
currentDispensed.dispensed_id =(int) reader["dispensed_id"]; 
if ((columns & Columns.task_id) == Columns.task_id && reader["task_id"]!=DBNull.Value)
currentDispensed.task_id =(int) reader["task_id"]; 
...
public static Dispensed LoadDispensedByPk( int dispensed_id )
{
return LoadDispensed( " dispensed_id="+dispensed_id );
}

public static Dispensed LoadDispensedByPk( int dispensed_id , IDbConnection conn)
{
return LoadDispensed(" dispensed_id="+dispensed_id , conn);
}
...
lock (ConnectionFactory.connectionString) { this.dispensed_id = ConnectionFactory.GetNextId();
...
qry.Replace(',', ' ', qry.Length - 1,1);
qry.Append(" where ");
qry.Append("dispensed_id = "+dispensed_idDbString);
}
...
{
IDbCommand cmd = conn.CreateCommand();
cmd.CommandText = "DELETE Dispensed where dispensed_id = "+ dispensed_id;
...
{
ConnectionFactory.ExecuteQuery("delete Dispensed where " + where);
}
...
cash_dispensed1= 256,
cash_dispensed2= 512,
cash_dispensed3= 1024,
cash_dispensed4= 2048,
cash_dispensed5= 4096,
cash_dispensed6= 8192,
cash_dispensed7= 16384,
cash_purged1= 32768,
cash_purged2= 65536,
cash_purged3= 131072,
cash_purged4= 262144,
cash_purged5= 524288,
cash_purged6= 1048576,
cash_purged7= 2097152,
clearing_datetime= 4194304,
dispensed_id= 8388608,
task_id= 16777216
}
#endregion
public void BulkSave(List<Dispensed> dataArray,SqlTransaction dbTrx)
{
...
Row["dispensed_id"] =ConnectionFactory.GetNextId();
