...
public DailyFeedSchedule( int daily_feed_schedule_id,DateTime date_from,DateTime date_to,int created_by,DateTime creation_time,bool is_executed,string mcn,int retry_count ) 
{
...
public DailyFeedSchedule( DateTime date_from,DateTime date_to,int created_by,DateTime creation_time,bool is_executed,string mcn,int retry_count,string failure_reason,int? atm_id,DateTime? schedule_date,bool? delete_current_data,bool? enable_dff_generation )
{
this.date_from = date_from;
this.date_fromChanged = true;
this.date_to = date_to;
...
private DailyFeedSchedule( int daily_feed_schedule_id,DateTime date_from,DateTime date_to,int created_by,DateTime creation_time,bool is_executed,string mcn,int retry_count,string failure_reason,int? atm_id,DateTime? schedule_date,bool? delete_current_data,bool? enable_dff_generation )
{
...
private int daily_feed_schedule_id;
public int DailyFeedScheduleId
{
...
currentDailyFeedSchedule.daily_feed_schedule_id =(int) reader["daily_feed_schedule_id"]; 
...
currentDailyFeedSchedule.created_by =(int) reader["created_by"]; 
...
currentDailyFeedSchedule.atm_id =(int?) reader["atm_id"]; 
...
public static DailyFeedSchedule LoadDailyFeedScheduleByPk( int daily_feed_schedule_id )
{
return LoadDailyFeedSchedule( " daily_feed_schedule_id="+daily_feed_schedule_id );
}

public static DailyFeedSchedule LoadDailyFeedScheduleByPk( int daily_feed_schedule_id , IDbConnection conn)
{
...
lock (ConnectionFactory.connectionString) { this.daily_feed_schedule_id = ConnectionFactory.GetNextId();
...
{
IDbCommand cmd = conn.CreateCommand();
cmd.CommandText = "DELETE Daily_feed_schedule where daily_feed_schedule_id = "+ daily_feed_schedule_id;
...
{
ConnectionFactory.ExecuteQuery("delete Daily_feed_schedule where " + where);
}
...
atm_id= 512,
schedule_date= 1024,
delete_current_data= 2048,
enable_dff_generation= 4096
}
#endregion
public void BulkSave(List<DailyFeedSchedule> dataArray,SqlTransaction dbTrx)
{
...
DataRow Row;
Row = dt.NewRow();
Row["daily_feed_schedule_id"] =ConnectionFactory.GetNextId();
