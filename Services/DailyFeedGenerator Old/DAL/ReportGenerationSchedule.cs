...
public ReportGenerationSchedule( DateTime next_generation_at,int report_schedule_id )
{
...
private ReportGenerationSchedule( int report_generation_schedule_id,DateTime next_generation_at,int report_schedule_id )
{
...
private int report_generation_schedule_id;
public int ReportGenerationScheduleId
{
...
currentReportGenerationSchedule.report_generation_schedule_id =(int) reader["report_generation_schedule_id"]; 
...
currentReportGenerationSchedule.report_schedule_id =(int) reader["report_schedule_id"]; 
...
public static ReportGenerationSchedule LoadReportGenerationScheduleByPk( int report_generation_schedule_id )
{
return LoadReportGenerationSchedule( " report_generation_schedule_id="+report_generation_schedule_id );
}

public static ReportGenerationSchedule LoadReportGenerationScheduleByPk( int report_generation_schedule_id , IDbConnection conn)
{
...
lock (ConnectionFactory.connectionString) { this.report_generation_schedule_id = ConnectionFactory.GetNextId();
...
{
IDbCommand cmd = conn.CreateCommand();
cmd.CommandText = "DELETE Report_generation_schedule where report_generation_schedule_id = "+ report_generation_schedule_id;
...
{
ConnectionFactory.ExecuteQuery("delete Report_generation_schedule where " + where);
}
...
{
report_generation_schedule_id= 1,
next_generation_at= 2,
report_schedule_id= 4
}
#endregion
public void BulkSave(List<ReportGenerationSchedule> dataArray,SqlTransaction dbTrx)
{
...
DataRow Row;
Row = dt.NewRow();
Row["report_generation_schedule_id"] =ConnectionFactory.GetNextId();
