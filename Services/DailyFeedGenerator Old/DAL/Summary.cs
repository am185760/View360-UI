...
using System;
 ...
 public Summary() { }
 public Summary( int atm_id,decimal closing_balance,decimal withdrawals,decimal pre_withdrawals,DateTime trxn_datetime,int summary_id ) 
 {
 this.atm_id = atm_id;
 ...
 public Summary( int atm_id,decimal closing_balance,decimal withdrawals,decimal pre_withdrawals,DateTime trxn_datetime,decimal? return_amount,decimal? replenishment_amount,int? cash_remaining1,int? cash_remaining2,int? cash_remaining3,int? cash_remaining4,int? cash_remaining5,int? cash_remaining6,int? cash_remaining7,int? return_type1,int? return_type2,int? return_type3,int? return_type4,int? return_type5,int? return_type6,int? return_type7,int? cash_added1,int? cash_added2,int? cash_added3,int? cash_added4,int? cash_added5,int? cash_added6,int? cash_added7,DateTime? generated_at,decimal? opening_balance )
 {
 this.atm_id = atm_id;
 this.atm_idChanged = true;
 this.closing_balance = closing_balance;
 ...
 private Summary( int atm_id,decimal closing_balance,decimal withdrawals,decimal pre_withdrawals,DateTime trxn_datetime,decimal? return_amount,decimal? replenishment_amount,int summary_id,int? cash_remaining1,int? cash_remaining2,int? cash_remaining3,int? cash_remaining4,int? cash_remaining5,int? cash_remaining6,int? cash_remaining7,int? return_type1,int? return_type2,int? return_type3,int? return_type4,int? return_type5,int? return_type6,int? return_type7,int? cash_added1,int? cash_added2,int? cash_added3,int? cash_added4,int? cash_added5,int? cash_added6,int? cash_added7,DateTime? generated_at,decimal? opening_balance )
 {
 this.atm_id = atm_id;
 this.atm_idChanged = true;
 this.closing_balance = closing_balance;
...
Summary currentSummary;
 ...
 currentSummary.atm_id =(int) reader["atm_id"]; 
 ...
 currentSummary.summary_id =(int) reader["summary_id"]; 
...
Summary _summary = null;
 ...
 public static Summary LoadSummaryByPk( int summary_id )
 {
 return LoadSummary( " summary_id="+summary_id );
 }

 public static Summary LoadSummaryByPk( int summary_id , IDbConnection conn)
 {
 ...
 lock (ConnectionFactory.connectionString) { this.summary_id = ConnectionFactory.GetNextId();
 ...
 {
 IDbCommand cmd = conn.CreateCommand();
 cmd.CommandText = "DELETE Summary where summary_id = "+ summary_id;
 ...
 {
 ConnectionFactory.ExecuteQuery("delete Summary where " + where);
 }
...
cash_remaining1= 256,
cash_remaining2= 512,
cash_remaining3= 1024,
cash_remaining4= 2048,
cash_remaining5= 4096,
cash_remaining6= 8192,
cash_remaining7= 16384,
return_type1= 32768,
return_type2= 65536,
return_type3= 131072,
return_type4= 262144,
return_type5= 524288,
return_type6= 1048576,
return_type7= 2097152,
cash_added1= 4194304,
cash_added2= 8388608,
cash_added3= 16777216,
cash_added4= 33554432,
cash_added5= 67108864,
cash_added6= 134217728,
cash_added7= 268435456,
generated_at= 536870912,
opening_balance= 1073741824
 }
 #endregion
 public void BulkSave(List<Summary> dataArray,SqlTransaction dbTrx)
 {
 ...
 Row["summary_id"] =ConnectionFactory.GetNextId();
