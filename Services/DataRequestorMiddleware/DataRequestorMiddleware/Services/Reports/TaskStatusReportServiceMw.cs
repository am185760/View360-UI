...
{
    public class TaskStatusReportServiceMw
    {
        //private Executor _executor { get; set; }
        private ILogger<TaskStatusReportServiceMw> _logger;

        public TaskStatusReportServiceMw(ILogger<TaskStatusReportServiceMw> logger)
        {
            _logger = logger;
        }

        //public TaskStatusReportServiceMw()
        //{
        ...
        public BaseModel GetTaskStatusReport(TaskStatusReportRequestModel taskStatusReportRequest)
        {
            ...
            _logger.LogWarning("[TaskStatusReportServiceMw:GetTaskStatusReport] going to execute GetReportTaskStatus sp");
            DataTableResult result = _executor.ExecuteDSRequest<DataTableResult>("GetReportTaskStatus", new SqlParameter[] {  param2, param3, param4, param5 }, taskStatusReportRequest.SelectedAtms, string.Join(",", taskStatusReportRequest.SelectedAtms));
            _logger.LogWarning("[TaskStatusReportServiceMw:GetTaskStatusReport] return from GetReportTaskStatus sp");
