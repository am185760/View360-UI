...
using System;
 ...
 public ReportTask() { }
 public ReportTask( int report_task_id,int report_schedule_id,int retry_count,DateTime creation_time,string status,DateTime schedule_date ) 
 {
 ...
 public ReportTask( int report_schedule_id,string file_path_attachment,int retry_count,string failure_reason,DateTime creation_time,DateTime? last_invoked_at,string status,DateTime schedule_date,DateTime? from_date,DateTime? to_date,int? atm_id )
 {
 this.report_schedule_id = report_schedule_id;
 this.report_schedule_idChanged = true;
 ...
 private ReportTask( int report_task_id,int report_schedule_id,string file_path_attachment,int retry_count,string failure_reason,DateTime creation_time,DateTime? last_invoked_at,string status,DateTime schedule_date,DateTime? from_date,DateTime? to_date,int? atm_id )
 {
...
ReportTask _reporttask = null;
 ...
 public static ReportTask LoadReportTaskByPk( int report_task_id )
 {
 return LoadReportTask( " report_task_id="+report_task_id );
 }

 public static ReportTask LoadReportTaskByPk( int report_task_id , IDbConnection conn)
 {
 ...
 lock (ConnectionFactory.connectionString) { this.report_task_id = ConnectionFactory.GetNextId();
 ...
 {
 ConnectionFactory.ExecuteQuery("delete Report_task where " + where);
 }
...
atm_id= 2048
 ...
 DataRow Row;
 Row = dt.NewRow();
 Row["report_task_id"] =ConnectionFactory.GetNextId();
