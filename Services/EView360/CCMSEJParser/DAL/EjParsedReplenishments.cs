...
namespace Avanza.CCMS.DAL
{
    ...
    public class EjParsedReplenishments
    {
        ...
        public EjParsedReplenishments(int? atm_id, int? notes_added_type1, int? notes_added_type2, int? notes_added_type3, int? notes_added_type4, DateTime? rep_datetime, int? task_id, DateTime? processing_datetime, int? start_index, int? end_index, int? last_tsn, int? notes_Added_type5, int? notes_Added_type6, int? notes_Added_type7, bool? is_bill_dispenser)
        {
            this.atm_id = atm_id;
        ...
        private EjParsedReplenishments(int ej_parsed_replenishments_id, int? atm_id, int? notes_added_type1, int? notes_added_type2, int? notes_added_type3, int? notes_added_type4, DateTime? rep_datetime, int? task_id, DateTime? processing_datetime, int? start_index, int? end_index, int? last_tsn, int? notes_Added_type5, int? notes_Added_type6, int? notes_Added_type7, bool? is_bill_dispenser)
        {
        ...
        {
            IDbCommand cmd = conn.CreateCommand();
            cmd.CommandText = "DELETE Ej_parsed_replenishments whereej_parsed_replenishments_id= " + ej_parsed_replenishments_id;
