...
namespace Avanza.CCMS.DAL
{
    ...
    public class AtmAlert
    {
        ...
        public void Delete()
        {
            ConnectionFactory.ExecuteQuery("DELETE Atm_alert where atm_alert_id = " + atm_alert_id);
        }
