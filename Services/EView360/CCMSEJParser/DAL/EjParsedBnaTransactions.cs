 ...
 namespace Avanza.CCMS.DAL
{
    ...
    public class EjParsedBnaTransaction
    {
        ...
        public EjParsedBnaTransaction(DateTime? trxn_datetime, string terminal_id, string seq, string account_type, string pan, string consumer_message_id, string dispute_status, decimal? amount_authorized, string status, string comment, string processed_tran, int atm_id, DateTime generated_at, int start_index, int end_index, int task_id, bool is_eligible, DateTime? transaction_start_time, string transaction_end_time, string card_taken_time, bool? is_disputed_transaction, string host_tsn, string account_no, DateTime? posting_date, string currency, int? transaction_type_id, string network)
        {
        ...
        #endregion
        public void BulkSave(List<EjParsedBnaTransaction> dataArray, SqlTransaction dbTrx)
        {
