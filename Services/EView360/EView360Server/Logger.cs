		...
		public class XmlLogWriter
		{
			...
			public static void InitXmlLogWriter(string logFileName)
			{
				...
				catch(System.IO.FileNotFoundException)
				{
					...
					xmlWriter.WriteElementString("Time",DateTime.Now.ToShortDateString()+" "+DateTime.Now.ToShortTimeString());
			...
			{				
				...
				for (int i=0; i<task.activities.Count; i++)
				{
					...
					xmlWriter.WriteStartElement("Activity","");
					xmlWriter.WriteElementString("Time",act.Time.ToShortDateString()+" "+act.Time.ToShortTimeString());
