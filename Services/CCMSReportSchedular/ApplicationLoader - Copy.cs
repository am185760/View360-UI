...
namespace CCMSReportSchedular
{
    class CreateProcessAsUserWrapper
    {
        ...
        public static bool LaunchChildProcess(string ChildProcName, string args)
        {
            bool ChildProcStarted = false;
                    ...
                    if (WTS_CONNECTSTATE_CLASS.WTSActive == tSessionInfo.State)
                    {
                        ...
                        if (WTSQueryUserToken(tSessionInfo.SessionID, out hToken))
                        {
                            ...
                            ChildProcStarted = CreateProcessAsUser(
                             ...
                             ChildProcName,      // Name of the process to be started.
                                ...
                                false,              // Does NOT inherit parent's handles.
                                 0x00000010,                  // No any specific creation flag.
                            ...
                            if (ChildProcStarted)
                            {
                                ...
                                WaitForSingleObject(tProcessInfo.hProcess,60*1000*30);
