...
namespace OperationsApi.BusinessLayer
{
    public class ReplenishmentService
    {
        ...
        public ReplenishmentService(Executor executor)
        {
            _executor = executor;
        }

        public BaseModel GetReplenishments(ReplenishmentFilter replenishmentFilter)
        {
            string filter = "";
            ...
            param3.Value = "title asc";

            SqlParameter param4 = new SqlParameter();
            param4.ParameterName = "@ArchiveYear";
            param4.SqlDbType = SqlDbType.VarChar;
            param4.Value = replenishmentFilter?.ArchiveYear != 0 ? "_" + replenishmentFilter.ArchiveYear.ToString() : "";

            DataTableResult result = _executor.ExecuteDSRequest<DataTableResult>("GetReplenishments", new SqlParameter[] { param1, param2, param3, param4 }, replenishmentFilter.SelectedAtmIds);
            ...
            if (dataTable != null)
            {
                foreach (DataRow row in dataTable.Rows)
                {
                    ReplenishmentViewModel atmWithdrawalTransaction = new()
                    {
                        ...
                        GeneratedBy = !DBNull.Value.Equals(row["generated_by"]) ? Convert.ToInt64(row["generated_by"]) : 0,
        ...
        public BaseModel PostReplenishment(ReplenishmentViewModel postRep)
        {
            ...
            DataTableResult result = _executor.ExecuteDSRequest<DataTableResult>("PostReplenishment", new SqlParameter[] { param1, param2, param3, param4, param5, param6, param7, param8, param9, param10, param11, param12, param13, param14 }, Atmlist);

            if(!result.ExceptionMessage.IsNullOrEmpty() )
